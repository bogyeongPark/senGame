// var original ={{value|tojson}};
// console.log(original);
            //data 받아오기
var trial = document.querySelector('.origin');
for (i = 0; i < original.length; i++) {
	var div = document.createElement('div');
	div.className = 'container';
	var span = document.createElement('span');
	span.className = 'word';
	span.innerHTML = original[i];
	div.appendChild(span);
	trial.appendChild(div);
}
...
// bool to prevent competing animations (clicking a word before the previous word has finished moving)
